<template>
  <div class="home">
      ...
      <el-col class="flex" :md="12">
        <div class="content">
          ...
          <div class="btn-wrap mt60">
            <el-button class="lg fs18 long" type="primary">
              开始使用<i class="el-icon-back r"></i>
            </el-button>
          </div>
    ...
    <el-row class="wrap1040 mt100 pb120">
      <el-col :md="6" :sm="12">
