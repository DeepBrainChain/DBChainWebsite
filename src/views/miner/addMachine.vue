  ...
  <div class="addMc wrap1440">
    ...
    <template v-if="!isEditor">
      ...
      <div class="text mb30">
        ...
        <a class="is-link" href="https://github.com/DeepBrainChain/DBC-AIComputingNet">进入github</a>
    ...
    <div class="label mt20">{{isEditor ? 1:2}} .输入时间</div>
    <div class="text">
      <span>出租开始时间:</span>
      <mu-text-field
        class="mc-input"
    ...
    <div class="label mt20">{{isEditor ? 2:3}}.输入机器id</div>
    <div class="text">
      <span>机器id:</span>
      <mu-text-field
        :disabled="isEditor"
    ...
    <div class="subText">其中4%代币用于DBC共识节点奖励，4%代币会被燃烧掉。深脑链基金会和DBChain平台不收取任何费</div>
...
export default {
  ...
  created() {
    ...
    this.can_rent_start_time_later = Math.floor(
      this.$route.query.can_rent_start_time_later / 60
    );
