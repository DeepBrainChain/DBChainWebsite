  ...
  <div class="addMc wrap1440">
    ...
    <template v-if="!isEditor">
      ...
      <div class="text mb30">
        ...
        <a class="is-link" href="/DBC_install.docx" target="_blank">下载操作手册</a>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.can_rent_start_time_later = this.$route.query.can_rent_start_time_later > 0 ? 0 : Math.floor(this.$route.query.can_rent_start_time_later / 60)
