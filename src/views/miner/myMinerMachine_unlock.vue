<template>
  <div>
    ...
    <template v-if="res_body.content.length > 0">
      ...
      >
        ...
        <div class="status-wrap">
          ...
          <div class="flex">
            <div
              v-if="item.mcData.half_precision_tflops"
              class="td"
            >
              <span class="fs16">
          ...
          <div class="flex">
            <div
              v-if="item.mcData.single_precision_tflops"
              class="td"
            >
              <span class="fs16">
          ...
          <div class="flex">
            <div
              v-if="item.mcData.duoble_precision_tflops"
              class="td"
            >
              <span class="fs16">
    ...
    <!--    reload-dlg-->
    <dlg-reload :open.sync="dlgReload_open" />
    <!--    increaseHD-dlg-->
    <dlg-hd :open.sync="dlgHD_open" />
    <!--    bindMail-dlg-->
    <dlg-mail
    ...
    pushToEditMc(item) {
      ...
      this.$router.push({
        ...
        query: {
          ...
          discount_quarter: item.discount_quarter,
