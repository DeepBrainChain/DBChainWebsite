<template>
  <div class="wrap1200 bg-box">
    <div class="border-box">
      <h3 class="wallet-title">Open Wallet</h3>
      <p class="wallet-subText">How would you like to access your wallet?</p>
      <el-radio-group class="wallet-group" v-model="radio" @change="radioChange">
        <div class="row">
          <el-radio class="radio-item" label="1">Keystore File</el-radio>
        </div>
        <div class="row">
          <el-radio class="radio-item" label="2">Private key</el-radio>
        </div>
        <div class="row">
          <el-radio class="radio-item" label="3">Encrypted key</el-radio>
        </div>
      </el-radio-group>
    ...
    methods: {
      ...
      continueEncryptedKey() {
        if (wallet.isNEP2(this.encryptedKey)) {
          ...
          this.errText = 'Invalid Encrypted Key. A valid NEP-2 Encrypted Key looks like 6PYTp4fNNhn2oV6HZhjzfg6YoeC8r1wWsCPikEJXxcTmsitDm92mWpdqd6'
        }
      },
      keyFileChange(file) {
