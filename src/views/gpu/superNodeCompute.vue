...
export default {
  ...
  methods: {
    ...
    openDlg_cpu_switch(item, index) {
      ...
      this.placeOrderData.images_tag = "dbc super node";
    ...
    showMachines(machines, currentPage, pageSize) {
      ...
      for (
        ...
        machineIndex < currentPage * pageSize && machineIndex < machines.length; //当前分页机器索引范围 //机器索引最大值
        machineIndex++
      ) {
