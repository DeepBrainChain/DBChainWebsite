<template>
  <div class="wrap">
    <div class="top">
      ...
      <div class="describe">
        常用数据集无需上传，聪图云为用户提供了现成的主流深度学习数据集，供用户快速访问和使用。
      </div>
    </div>
    <div class="container">
      <div class="container-top">
        <div class="options" ref="options" @click="handlerClickOption($event)">
          <div class="option-1" index="0" ref="option1">图像数据集</div>
          <div class="option-2" index="1" ref="option2">自然语言处理数据集</div>
          <div class="option-3" index="2" ref="option3">KAGGLE</div>
          <div class="option-4" index="3" ref="option4">天池</div>
        </div>
      ...
      <div class="container-bottom">
        <div class="rotation-chart">
          ...
          <div class="chart-4" ref="chart4">
            ...
            <div class="chart-col">
              <ul class="col-1">
                <li>ChnSentiCorp_htl_all</li>
                <li>weibo_senti_100k</li>
                <li>SIGHAN Bakeoff 2005</li>
              </ul>
              <ul class="col-2">
                <li>ez_douban</li>
                <li>BERT</li>
