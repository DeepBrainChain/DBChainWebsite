...
export default {
  ...
  // 订单列表
  myvirtual:{
    tip1:'在确认租用之前创建虚拟机，虚拟机创建成功后确认租用，超过倒计时没有租用，则自动订单自动取消',
    tip2:'虚拟机正在创建中...',
    tip3:'虚拟机创建成功',
    tip4: '提示：点击确认租用之前，请确保虚拟机已经创建成功',
    tip5: '确认重启虚拟机吗？',
    tip6: '温馨提示：每次续费最短7天时间',
    tip7: '可在6000-60000之间随意设置，如果同一个机器想要创建多个虚拟机，则不同虚拟机之间的开放端口不能重合，否则虚拟机会创建失败',
    tip8: '可在5000-6000之间设置,如果同一个机器想要创建多个虚拟机，则不同虚拟机之间的端口不能重合，否则虚拟机会创建失败',
